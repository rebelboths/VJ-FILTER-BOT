...
PICS = (environ.get('PICS', 'https://envs.sh/aAF.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6717382350 1009704073 2116648189').split()] # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001723647800') # give your force subscribe channel id here else leave it blank
